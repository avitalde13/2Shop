...
import com.twoshop.ViewModel.ProfileViewModel
import com.twoshop.activities.LoginActivity
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        profileViewModel.getUserByUid(uid){ userEntity ->
            if(userEntity!=null){
                ...
                Picasso.get().load(userEntity.profileImg).placeholder(R.drawable.place_holder_image)
                    .into(imageView)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val editButton: MaterialButton = view.findViewById(com.twoshop.R.id.edit_profile_btn)
